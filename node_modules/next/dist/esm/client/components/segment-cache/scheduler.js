...
function pingPPRSegmentRevalidation(now, currentSegment, route, routeKey, segmentKey) {
    ...
    switch(revalidatingSegment.status){
        case EntryStatus.Empty:
            ...
            // upon completion.
            upsertSegmentOnCompletion(segmentKey, spawnPrefetchSubtask(fetchSegmentOnCacheMiss(route, upgradeToPendingSegment(revalidatingSegment, FetchStrategy.PPR), routeKey, segmentKey)));
            break;
        case EntryStatus.Pending:
            break;
        case EntryStatus.Fulfilled:
...
function pingFullSegmentRevalidation(now, currentSegment, segmentKey) {
    ...
    if (revalidatingSegment.status === EntryStatus.Empty) {
        ...
        upsertSegmentOnCompletion(segmentKey, waitForSegmentCacheEntry(pendingSegment));
