...
export function startPPRNavigation(oldCacheNode, oldRouterState, newRouterState, prefetchData, prefetchHead, isPrefetchHeadPartial, scrollableSegmentsResult) {
    const segmentPath = [];
