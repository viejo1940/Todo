 ...
 * entry, If not, it adds an empty entry to the cache and returns it.
 */
export declare function readOrCreateSegmentCacheEntry(now: number, route: FulfilledRouteCacheEntry, path: string): SegmentCacheEntry;
export declare function readOrCreateRevalidatingSegmentEntry(now: number, prevEntry: SegmentCacheEntry): SegmentCacheEntry;
export declare function upsertSegmentEntry(now: number, segmentKeyPath: string, candidateEntry: SegmentCacheEntry): SegmentCacheEntry | null;
...
export declare function fetchSegmentOnCacheMiss(route: FulfilledRouteCacheEntry, segmentCacheEntry: PendingSegmentCacheEntry, routeKey: RouteCacheKey, segmentKeyPath: string): Promise<PrefetchSubtaskResult<FulfilledSegmentCacheEntry> | null>;
